...
def create_button(x=100, y=100, width=100, height=30):
    button = ctk.CTkButton(root, text="New Button", width=width, height=height)
...
def update_json():
    ...
    for button in buttons:
        ...
        button_cmd = f"create_button({new_x}, {new_y}, {button_width}, {button_height})"
