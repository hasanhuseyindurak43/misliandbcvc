...
def create_button():
    ...
    button.place(x=100, y=100)  # Başlangıç konumu
...
def update_json():
    ...
    list_1 = [
        ...
        "import tkinter as tk",
        f"root = ctk.CTk()",
        f"root.geometry(\"{width}x{height}+10+101\")",
    ...
    for button in buttons:
        ...
        to_liste.append(
            f"button = ctk.CTkButton(root, text=\"New Button\")"
        )
        to_liste.append(
            f"button.place(x={new_x}, y={new_y})"
        )
