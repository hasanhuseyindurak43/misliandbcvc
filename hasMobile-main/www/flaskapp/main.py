...
# IMPORT FLASK
from flask import Flask, request, render_template, Response, session, send_from_directory, make_response, redirect, url_for, current_app
...
def sitemap():
    ...
    sitemap_xml = render_template('views/sitemap_template.xml', pages=pages)
